import{j as X}from"./jsx-runtime-1u1Nfn-y.js";import{d as _,t as m}from"./Theme-DB1c5mYq.js";import"./index-DmTNtw1v.js";var o=(e=>(e.SUBMIT="submit",e.RESET="reset",e.BUTTON="button",e))(o||{}),r=(e=>(e.PRIMARY="primary",e.SECONDARY="secondary",e.GHOST="ghost",e.NEGATIVE="negative",e.POSITIVE="positive",e.DARK="dark",e.TEXT="text",e))(r||{}),t=(e=>(e.SM="small",e.LG="large",e))(t||{});const F=_.button`
  display: inline-flex;
  padding: 12px;
...
}`,...(w=(D=p.parameters)==null?void 0:D.docs)==null?void 0:w.source}}};const ee=["Primary","Secondary","Disabled","Positive","Negative","Ghost","Dark","Text"];export{u as Dark,n as Disabled,c as Ghost,i as Negative,l as Positive,a as Primary,s as Secondary,p as Text,ee as __namedExportsOrder,Z as default};

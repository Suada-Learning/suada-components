...
export const DarkTrashCan = forwardRef<SVGSVGElement, SvgProps>(
  ({ className, onClick, ...props }, ref) => {
    return (
      ...
      >
        <g id='Trash-can'>
          <g id='Vector'>
            <path d='M7 6H6V12H7V6Z' fill='#68707A' />
            <path d='M10 6H9V12H10V6Z' fill='#68707A' />
            <path
              ...
              fill='#68707A'
            />
            <path d='M10 1H6V2H10V1Z' fill='#68707A' />
          </g>
        </g>
      </svg>
    )

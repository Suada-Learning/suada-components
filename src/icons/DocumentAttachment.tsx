...
export const DocumentAttachment = forwardRef<SVGSVGElement, SvgProps>(
        ...
        <g id='Document--attachment'>
          <g id='Vector'>
            <path
              ...
              fill='#68707A'
            />
            <path d='M12 5H8.5V6H12V5Z' fill='#68707A' />
            <path d='M12 7.5H8V8.5H12V7.5Z' fill='#68707A' />
            <path d='M12 10H7.5V11H12V10Z' fill='#68707A' />
            <path

...
export const TrashCan: React.FC<SvgProps> = ({ className, onClick, ...props }) => {
  return (
    <svg
      width='20'
      height='20'
    ...
    >
      <g id='Trash-can'>
        <g id='Vector'>
          <path d='M8.75 7.5H7.5V15H8.75V7.5Z' fill='#B3B3B8' />
          <path d='M12.5 7.5H11.25V15H12.5V7.5Z' fill='#B3B3B8' />
          <path
            ...
            fill='#B3B3B8'
          />
          <path d='M12.5 1.25H7.5V2.5H12.5V1.25Z' fill='#B3B3B8' />
        </g>
      </g>
    </svg>
  )

...
export var Button = function (_a) {
    ...
    return (_jsxs(StyledButton, { "$type": type, "$size": size, disabled: !!disabled, style: customStyles, onClick: onClick, type: htmlType, className: "".concat(className, " button-theme-color"), children: [iconLeft, label, iconRight] }));
};

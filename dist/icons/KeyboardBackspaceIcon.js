...
export var KeyboardBackspaceIcon = forwardRef(function (_a, ref) {
    var className = _a.className, onClick = _a.onClick, _b = _a.fill, fill = _b === void 0 ? 'inherit' : _b, props = __rest(_a, ["className", "onClick", "fill"]);
...
//# sourceMappingURL=KeyboardBackspaceIcon.js.map
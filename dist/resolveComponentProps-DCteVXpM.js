...
function mergeSlotProps(parameters) {
  ...
  if (!getSlotProps) {
    ...
    const joinedClasses = DefaultPropsProvider.clsx(additionalProps?.className, className, externalForwardedProps?.className, externalSlotProps?.className);
    const mergedStyle = {
  ...
  const joinedClasses = DefaultPropsProvider.clsx(internalSlotProps?.className, additionalProps?.className, className, externalForwardedProps?.className, externalSlotProps?.className);
  const mergedStyle = {
...
//# sourceMappingURL=resolveComponentProps-DCteVXpM.js.map
